...
/* ------------------------------- Pin Definition ------------------------------ */
#define RESET_PIN    PB6    // DIP Switch 2
#define SPEAKER_PIN  D10

#define GREEN_LED    PC1
#define GREEN_LED2   PC7   // Always on as it is connected to the keypad power pin - acts as a status ON LED
#define RED_LED      PC0
#define RED_LED2     PC3
...
AccelStepper stepper(AccelStepper::HALF4WIRE, A5, A4, A3, A2);
