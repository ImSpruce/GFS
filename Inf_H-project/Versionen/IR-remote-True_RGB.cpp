...
void setup() {
    ...
    Serial.println("        |                                                                                         |     |                 |");
    Serial.println("        | Button 1/1: - LED1 ON       | Button 2/1: - RGB +10 Blue  |                             |     | CH- | CH  | CH+ |");
    Serial.println("        | Button 1/2: - LED1 OFF      | Button 2/2: - RGB -10 Blue  |                             |     | |<< | >>| | >|| |");
    Serial.println("        | Button 1/3: - LED2 ON       | Button 2/3: - RGB +10 Red   |                             |     |  -  |  +  | EQ  |");
    Serial.println("        | Button 1/4: - LED2 OFF      | Button 2/4: - RGB -10 Red   |                             |     |  0  | 100+| 200+|");
    Serial.println("        |                             | Button 2/5: - RGB +10 Green |                             |     |  1  |  2  |  3  |");
    Serial.println("        |                             | Button 2/6: - RGB -10 Green |                             |     |  4  |  5  |  6  |");
...
/*
 * Eigene PWM funktion weil jemand dachte es ist eine ver**** gute Idee an der RGB-LED Blau und Rot
 * auf den Pins mit dem Selben Timer zu legen, weil wann würde denn jemals irgendwer auf die Idee 
 * kommen und eine farbe mit Blau UND Rot darzustellen also müsste man ja wirklich besc***** sein.
 *
*/
void software_PWM_Update(uint8_t pin, uint8_t duty) {
    if (micros() % 255 < duty) {
