 ...
 * And play defined sequences with the LED´s and the Buzzer
 *
 */
...
int coolMelody[] = {523, 659, 784, 988}; // TODO ----- implement game melodies as sequences
...
void update(u_int8_t red, u_int8_t green, u_int8_t blue)
{
